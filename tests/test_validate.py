...
class TestTerraformValidator:
    ...
    def test_has_terraform_files_with_tf_files(self, tmp_path):
    ...
    def test_has_terraform_files_without_tf_files(self, tmp_path):
    ...
    def test_find_modules_empty_directory(self, tmp_path):
        """Test finding modules in empty directory."""
        modules = self.validator.find_modules(tmp_path)
        assert modules == []

    def test_find_modules_with_terraform_files(self, tmp_path):
    ...
    def test_check_documentation_complete(self, tmp_path):
    ...
    def test_check_documentation_missing_files(self, tmp_path):
    ...
    def test_check_documentation_no_files(self, tmp_path):
...
class TestIntegrationValidation:
    ...
    def test_find_real_modules(self):
