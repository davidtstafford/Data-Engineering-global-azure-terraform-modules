...
class TestCodeFormatter:
    ...
    def test_find_python_paths_includes_scripts(self):
    ...
    def test_find_python_paths_includes_tests(self):
    ...
    def test_find_terraform_paths_includes_terraform_dir(self):
    ...
    def test_find_terraform_paths_with_no_terraform_dir(self, tmp_path):
...
class TestCodeFormatterMethods:
    ...
    def test_find_python_paths_returns_list(self):
        """Test that find_python_paths returns a list."""
        paths = self.formatter.find_python_paths()
        assert isinstance(paths, list)

    def test_find_terraform_paths_returns_list(self):
